...
const Section_FAQ  = () => {
  ...
  const faqItems = {
    ...
    "Is HackDavis in-person or virtual?":"We are planning to host HackDavis 2022 as a fully in-person event. Participants will have the option to participate in-person at the University Credit Union Center in Davis, or participate virtually from the comfort of their homes! \n\nHackDavis will be organized in accordance with CDC, California, City of Davis, and UC Davis protocols. However, all plans are subject to change with evolving public health guidance.",
