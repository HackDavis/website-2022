...
const Section_FAQ  = () => {
  ...
  const faqItems = {
    ...
    "Is HackDavis in-person or virtual?":"Under new guidelines from the University, HackDavis 2022 will be a fully in-person event. Hackers will participate in-person at the University Credit Union Center at UC Davis - the first no-compromises in-person hackathon in California in nearly two years! HackDavis will be organized in accordance with CDC, California, City of Davis, and UC Davis protocols. However, all plans are subject to change with evolving public health guidance.",
    ...
    "What can I build?":"You can build whatever your heart desires, whether it's a webapp, mobile app, hardware hack, raspberry pi 3 project (will be provided), open source tool, or even a simple website! Any social good oriented project is recommended. Our main focus is to bring you a learning experience where you can have fun, ask questions, and experiment with technology.",
