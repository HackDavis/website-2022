    ...
    <div className={styles.wrapper}>
      <section className={styles.container}>
        ...
        <p>
          ...
          participants to hack for social good, and create an opportunity for
          us to explore the intersection between technology and society.
          <br /> <br />
          This April, over 800 students, hackers, and creators will come
          together for a weekend of hacking. For the 7th year in a row, we
          will bring the most talented students in California (and beyond!) to
