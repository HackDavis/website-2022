...
//Input: user_id, user's name, user's email, group_id, user's reason for applying
...
export async function addPendingMember(user_id, group_id, reason) {
    ...
    try {
        ...
        pending_members_map_copy[user_id] = [userData.name, userData.email, userData.leader_status, reason];
